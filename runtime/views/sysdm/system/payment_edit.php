	...
	<form action="<?php echo IUrl::creatUrl("/system/payment_update");?>" method="post">
		...
		<table class="table form-table">
			...
			<tr>
				...
				<td><input class="form-control" name="<?php echo isset($key)?$key:"";?>" type="text" value="<?php echo isset($paramData[$key])?$paramData[$key]:"";?>" /></td>
			</tr>
			<?php }?>
			...
			<tr>
				...
				<td>
                    <label class="radio-inline">
                        <input type="radio" name="poundage_type" value="1" onclick="$('#paymentFeeText').text('商品总额的百分比：');" checked="checked" />按商品总额的百分比
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="poundage_type" value="2" onclick="$('#paymentFeeText').text('固定收取的手续费：');" />按固定金额
                    </label>
                    <label class="radio-inline">
                        <span id="paymentFeeText">{说明}</span>
                        <input class="form-control w-auto" name="poundage" type="text" value=""  pattern="required" />
					</label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th>支付说明：</th>
				<td>
					<textarea id="note" name="note" style="width:100%;height:280px;"><?php echo isset($this->paymentRow['note'])?$this->paymentRow['note']:"";?></textarea>
